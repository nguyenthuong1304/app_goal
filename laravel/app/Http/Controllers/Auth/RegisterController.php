    ...
    */
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'profile_image' => ['file','mimes:jpeg,png,jpg,bmb'],
    ...
    protected function create(array $data)
    {
        ...
        // 画像のファイル名の設定と、画像のアップロード
         if(!isset($data['profile_image'])) {
             ...
             $file->move($target_path,$image_path);
             $image_path  = '/images/profile/' . $image_path;
         }
...
//        }
        ...
        // フラッシュメッセージ
        session()->flash('msg_success', 'Đăng ký người dùng đã hoàn tất');
